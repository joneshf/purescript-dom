...
sendString ws = sendImpl ws <<< unsafeToForeign

sendBlob :: WebSocket -> Blob -> Effect Unit
sendBlob ws = sendImpl ws <<< unsafeToForeign

sendArrayBuffer :: WebSocket -> ArrayBuffer -> Effect Unit
sendArrayBuffer ws = sendImpl ws <<< unsafeToForeign

sendArrayBufferView :: forall t. WebSocket -> ArrayView t -> Effect Unit
sendArrayBufferView ws = sendImpl ws <<< unsafeToForeign
